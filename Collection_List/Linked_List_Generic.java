...
public class Linked_List_Generic {
	
	public static void main(String[] args) {
		
		
		LinkedList <Integer> C = new LinkedList<> (); // Only we can pass the Character.
	 ...
	 LinkedList <Integer> D = new LinkedList<> (); // Only we can pass the Character.
